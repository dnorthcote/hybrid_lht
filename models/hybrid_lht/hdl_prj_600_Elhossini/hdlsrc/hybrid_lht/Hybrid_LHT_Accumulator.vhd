-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_600_Elhossini\hdlsrc\hybrid_lht\Hybrid_LHT_Accumulator.vhd
...
ARCHITECTURE rtl OF Hybrid_LHT_Accumulator IS
  ...
  SIGNAL kconst                           : unsigned(4 DOWNTO 0);  -- ufix5_En1
  SIGNAL kconst_1                         : unsigned(4 DOWNTO 0);  -- ufix5_En1
  SIGNAL shift_unsigned                   : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Data_Type_Conversion_out1        : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL Data_Type_Conversion_out1_1      : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL Gain_mul_temp                    : unsigned(9 DOWNTO 0);  -- ufix10_En1
  SIGNAL Gain_out1                        : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL Gain_out1_1                      : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL switch_compare_1                 : std_logic;
  SIGNAL Gain_out1_scalarexpand           : vector_of_unsigned5(0 TO 5);  -- ufix5 [6]
  SIGNAL Gain_out1_scalarexpand_dtc       : vector_of_unsigned6(0 TO 5);  -- ufix6 [6]
  SIGNAL shift_unsigned_1                 : vector_of_unsigned6(0 TO 5);  -- ufix6 [6]
  SIGNAL shift_2                          : vector_of_unsigned6(0 TO 5);  -- ufix6 [6]
  SIGNAL Switch_out1                      : vector_of_unsigned6(0 TO 5);  -- ufix6 [6]
  SIGNAL Switch_out1_1                    : vector_of_std_logic_vector6(0 TO 5);  -- ufix6 [6]
  SIGNAL AND1_out1                        : std_logic;
  SIGNAL mode_2                           : std_logic;
  SIGNAL Accumulator_with_Switches_out1   : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL Accumulator_with_Switches_out1_unsigned : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Constant_out1                    : unsigned(9 DOWNTO 0);  -- ufix10
  SIGNAL Multiport_Switch2_out1           : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              shift => Switch_out1_1,  -- ufix6 [6]
              hough_address => hough_param,  -- ufix10 [6]
              edge_rsvd => AND1_out1,
              mode => mode,
              read_address => read_rsvd,  -- uint16
              clear => clear,
              theta_index => index,  -- uint16
              hps => Accumulator_with_Switches_out1  -- ufix10
              );
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF s_axis_tlast = '1' THEN 
          IF HDL_Counter_out1 >= to_unsigned(16#258#, 10) THEN 
            HDL_Counter_out1 <= to_unsigned(16#000#, 10);
          ELSE 
  ...
  Compare_To_Constant3_out1 <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#258#, 10) ELSE
      '0';

  Constant1_out1 <= to_unsigned(16#0005#, 16);

  Constant2_out1 <= to_unsigned(16#03E7#, 16);
  ...
  kconst <= to_unsigned(16#14#, 5);

  HwModeRegister_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      kconst_1 <= to_unsigned(16#00#, 5);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        kconst_1 <= kconst;
      END IF;
  ...
  Data_Type_Conversion_out1 <= shift_unsigned(4 DOWNTO 0);

  HwModeRegister1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Data_Type_Conversion_out1_1 <= to_unsigned(16#00#, 5);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Gain_out1 <= Gain_mul_temp(5 DOWNTO 1);

  PipelineRegister_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Gain_out1_1 <= to_unsigned(16#00#, 5);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Gain_out1_scalarexpand_dtc_gen: FOR ii IN 0 TO 5 GENERATE
    Gain_out1_scalarexpand_dtc(ii) <= resize(Gain_out1_scalarexpand(ii), 6);
  END GENERATE Gain_out1_scalarexpand_dtc_gen;
  ...
  Switch_out1 <= Gain_out1_scalarexpand_dtc WHEN switch_compare_1 = '0' ELSE
      shift_2;
  ...
  Constant_out1 <= to_unsigned(16#000#, 10);
  ...
  Compare_To_Constant4_out1 <= '1' WHEN Gain_out1_1 = to_unsigned(16#00#, 5) ELSE
      '0';
  ...
  Compare_To_Constant2_out1 <= '1' WHEN read_unsigned = to_unsigned(16#03E7#, 16) ELSE
      '0';
