...
HD_PWD='C:/hybrid_lht/models/hybrid_lht/hdl_prj_600_Elhossini/vivado_prj/Hybrid_LHT_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Hybrid_LHT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Hybrid_LHT.tcl -notrace
