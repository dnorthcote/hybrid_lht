...
HD_PWD='C:/hybrid_lht/models/hybrid_lht/hdl_prj_600_Elhossini/vivado_prj/Hybrid_LHT_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hybrid_LHT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hybrid_LHT.tcl
