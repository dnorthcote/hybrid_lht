-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_512_Chen\hdlsrc\hybrid_lht\Hybrid_LHT_Accumulator.vhd
...
ARCHITECTURE rtl OF Hybrid_LHT_Accumulator IS
  ...
  COMPONENT Accumulator_with_Switches
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          shift                           :   IN    vector_of_std_logic_vector6(0 TO 59);  -- ufix6 [60]
          hough_address                   :   IN    vector_of_std_logic_vector10(0 TO 59);  -- ufix10 [60]
  ...
  SIGNAL Gain_out1_scalarexpand           : vector_of_unsigned5(0 TO 59);  -- ufix5 [60]
  SIGNAL Gain_out1_scalarexpand_dtc       : vector_of_unsigned6(0 TO 59);  -- ufix6 [60]
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              ...
              hough_address => hough_param,  -- ufix10 [60]
              edge_rsvd => AND1_out1,
              mode => mode,
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF s_axis_tlast = '1' THEN 
          IF HDL_Counter_out1 >= to_unsigned(16#200#, 10) THEN 
            HDL_Counter_out1 <= to_unsigned(16#000#, 10);
          ELSE 
  ...
  Compare_To_Constant3_out1 <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#200#, 10) ELSE
      '0';

  Constant1_out1 <= to_unsigned(16#003B#, 16);

  Constant2_out1 <= to_unsigned(16#02D5#, 16);
  ...
  Gain_out1_scalarexpand_dtc_gen: FOR ii IN 0 TO 59 GENERATE
  ...
  Compare_To_Constant2_out1 <= '1' WHEN read_unsigned = to_unsigned(16#02D5#, 16) ELSE
      '0';
