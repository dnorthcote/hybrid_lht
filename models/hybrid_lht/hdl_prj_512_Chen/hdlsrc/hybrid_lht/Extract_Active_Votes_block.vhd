-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_512_Chen\hdlsrc\hybrid_lht\Extract_Active_Votes_block.vhd
...
BEGIN
  ...
  Add_u <= signed(resize(Theta_unsigned, 10));
  ...
  nTheta_out1 <= to_unsigned(16#B4#, 8);
