-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_768p\hdlsrc\hybrid_lht\Accumulator_with_Switches.vhd
...
ARCHITECTURE rtl OF Accumulator_with_Switches IS
  ...
  SIGNAL Data_Type_Conversion_out1_scalarexpand : vector_of_unsigned11(0 TO 59);  -- ufix11 [60]
  SIGNAL hough_address_unsigned           : vector_of_unsigned11(0 TO 59);  -- ufix11 [60]
  SIGNAL Switch_out1                      : vector_of_unsigned11(0 TO 59);  -- ufix11 [60]
  SIGNAL Switch_out1_1                    : vector_of_std_logic_vector11(0 TO 59);  -- ufix11 [60]
  ...
  SIGNAL Accumulator_out1                 : vector_of_std_logic_vector11(0 TO 59);  -- ufix11 [60]
  SIGNAL Accumulator_out1_unsigned        : vector_of_unsigned11(0 TO 59);  -- ufix11 [60]
