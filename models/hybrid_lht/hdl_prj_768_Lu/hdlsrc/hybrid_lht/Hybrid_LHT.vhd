-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_768_Lu\hdlsrc\hybrid_lht\Hybrid_LHT.vhd
...
ARCHITECTURE rtl OF Hybrid_LHT IS
  ...
  COMPONENT Hybrid_LHT_Accumulator
    PORT( clk                             :   IN    std_logic;
          ...
          s_axis_tuser                    :   IN    std_logic;
          s_axis_tlast                    :   IN    std_logic;
          hough_param                     :   IN    vector_of_std_logic_vector11(0 TO 33);  -- ufix11 [34]
  ...
  SIGNAL Hybrid_LHT_Kernel_out4           : vector_of_std_logic_vector11(0 TO 33);  -- ufix11 [34]
  SIGNAL y                                : std_logic;  -- ufix1
  SIGNAL Hybrid_LHT_Kernel_out6           : vector_of_std_logic_vector6(0 TO 33);  -- ufix6 [34]
  SIGNAL Hybrid_LHT_Accumulator_out1      : std_logic;
  SIGNAL Hybrid_LHT_Accumulator_out2      : std_logic_vector(10 DOWNTO 0);  -- ufix11
...
BEGIN
  u_Hybrid_LHT_Kernel : Hybrid_LHT_Kernel
    PORT MAP( clk => clk,
              ...
              hough_param => Hybrid_LHT_Kernel_out4,  -- ufix11 [34]
              edge_rsvd => y,  -- ufix1
              shift => Hybrid_LHT_Kernel_out6  -- ufix6 [34]
              );
  ...
  u_Hybrid_LHT_Accumulator : Hybrid_LHT_Accumulator
    PORT MAP( clk => clk,
              ...
              m_axis_tdata => Hybrid_LHT_Accumulator_out2,  -- ufix11
