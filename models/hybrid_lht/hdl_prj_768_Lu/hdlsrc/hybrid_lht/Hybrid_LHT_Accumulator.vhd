-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_768_Lu\hdlsrc\hybrid_lht\Hybrid_LHT_Accumulator.vhd
...
ARCHITECTURE rtl OF Hybrid_LHT_Accumulator IS
  ...
  SIGNAL Gain_out1_scalarexpand           : vector_of_unsigned6(0 TO 33);  -- ufix6 [34]
  SIGNAL shift_unsigned_1                 : vector_of_unsigned6(0 TO 33);  -- ufix6 [34]
  SIGNAL shift_2                          : vector_of_unsigned6(0 TO 33);  -- ufix6 [34]
  SIGNAL Switch_out1                      : vector_of_unsigned6(0 TO 33);  -- ufix6 [34]
  SIGNAL Switch_out1_1                    : vector_of_std_logic_vector6(0 TO 33);  -- ufix6 [34]
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              shift => Switch_out1_1,  -- ufix6 [34]
              hough_address => hough_param,  -- ufix11 [34]
              edge_rsvd => AND1_out1,
              mode => mode,
  ...
  Constant1_out1 <= to_unsigned(16#0021#, 16);
