-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_768_Lu\hdlsrc\hybrid_lht\GetShift.vhd
...
ARCHITECTURE rtl OF GetShift IS
  ...
  SIGNAL Constant_out1                    : vector_of_unsigned7(0 TO 2);  -- ufix7 [3]
  SIGNAL Constant_out1_0                  : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL Relational_Operator_relop1       : std_logic;
  SIGNAL Constant_out1_1                  : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL Relational_Operator_relop2       : std_logic;
  SIGNAL Constant_out1_2                  : unsigned(6 DOWNTO 0);  -- ufix7
...
BEGIN
  ...
  Constant_out1(0) <= to_unsigned(16#22#, 7);
  Constant_out1(1) <= to_unsigned(16#44#, 7);
  Constant_out1(2) <= to_unsigned(16#66#, 7);
