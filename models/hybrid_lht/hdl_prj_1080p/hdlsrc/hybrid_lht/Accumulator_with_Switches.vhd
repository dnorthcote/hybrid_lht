-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_1080p\hdlsrc\hybrid_lht\Accumulator_with_Switches.vhd
...
ENTITY Accumulator_with_Switches IS
  PORT( clk                               :   IN    std_logic;
        ...
        hough_address                     :   IN    vector_of_std_logic_vector12(0 TO 59);  -- ufix12 [60]
        ...
        hps                               :   OUT   std_logic_vector(11 DOWNTO 0)  -- ufix12
        );
...
ARCHITECTURE rtl OF Accumulator_with_Switches IS
  ...
  COMPONENT Accumulator
    PORT( clk                             :   IN    std_logic;
          ...
          mode                            :   IN    std_logic;
          address                         :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          edge_rsvd                       :   IN    std_logic;
          hps                             :   OUT   std_logic_vector(11 DOWNTO 0)  -- ufix12
          );
  END COMPONENT;
  ...
  SIGNAL delayMatch1_reg                  : vector_of_unsigned12(0 TO 1);  -- ufix12 [2]
  SIGNAL Data_Type_Conversion_out1_1      : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL Data_Type_Conversion_out1_scalarexpand : vector_of_unsigned12(0 TO 59);  -- ufix12 [60]
  SIGNAL hough_address_unsigned           : vector_of_unsigned12(0 TO 59);  -- ufix12 [60]
  SIGNAL Switch_out1                      : vector_of_unsigned12(0 TO 59);  -- ufix12 [60]
  SIGNAL Switch_out1_1                    : vector_of_std_logic_vector12(0 TO 59);  -- ufix12 [60]
  ...
  SIGNAL delayMatch122_reg                : vector_of_unsigned16(0 TO 1);  -- ufix16 [2]
  SIGNAL Delay_out1_1                     : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Accumulator_out1                 : vector_of_std_logic_vector12(0 TO 59);  -- ufix12 [60]
  SIGNAL Accumulator_out1_unsigned        : vector_of_unsigned12(0 TO 59);  -- ufix12 [60]
  SIGNAL Selector_out1                    : unsigned(11 DOWNTO 0);  -- ufix12
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= read_address_unsigned(11 DOWNTO 0);
  ...
  outputgen2: FOR k1 IN 0 TO 59 GENERATE
  ...
  outputgen1: FOR k1 IN 0 TO 59 GENERATE
  ...
  BEGIN
    IF reset = '1' THEN
      delayMatch122_reg <= (OTHERS => to_unsigned(16#0000#, 16));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch122_reg(0) <= Delay_out1;
        delayMatch122_reg(1) <= delayMatch122_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch122_process;

  Delay_out1_1 <= delayMatch122_reg(1);
  ...
  GEN_LABEL: FOR k IN 0 TO 59 GENERATE
    u_Accumulator : Accumulator
      PORT MAP( clk => clk,
                ...
                shift => shift(k),  -- ufix6
                mode => mode_1,
                address => Switch_out1_1(k),  -- ufix12
                edge_rsvd => Multiport_Switch1_out1_1,
                hps => Accumulator_out1(k)  -- ufix12
                );
  END GENERATE;
