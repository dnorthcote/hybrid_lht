-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_1080p\hdlsrc\hybrid_lht\Gradient_Kernel_System.vhd
...
ARCHITECTURE rtl OF Gradient_Kernel_System IS
  ...
  SIGNAL Hough_Kernel_out2                : vector_of_std_logic_vector12(0 TO 59);  -- ufix12 [60]
...
BEGIN
  ...
  u_Hough_Kernel : Hough_Kernel_block
    PORT MAP( clk => clk,
              ...
              Index => Get_Index_and_Fix_Limits_out1,  -- uint8 [60]
              vEdge => y_1,  -- ufix1
              Rho => Hough_Kernel_out2  -- ufix12 [60]
              );
