-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_1080p\hdlsrc\hybrid_lht\Hough_Kernel_block.vhd
...
ARCHITECTURE rtl OF Hough_Kernel_block IS
  ...
  COMPONENT Hough_Kernel
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          X                               :   IN    std_logic_vector(10 DOWNTO 0);  -- sfix11
          Y                               :   IN    vector_of_std_logic_vector11(0 TO 179);  -- sfix11 [180]
          Index                           :   IN    vector_of_std_logic_vector8(0 TO 59);  -- uint8 [60]
          Rho                             :   OUT   vector_of_std_logic_vector12(0 TO 59)  -- sfix12 [60]
          );
  END COMPONENT;
  ...
  SIGNAL Look_Ahead_Hough_out1            : vector_of_std_logic_vector11(0 TO 179);  -- ufix11 [180]
  SIGNAL Hough_Kernel_out1                : vector_of_std_logic_vector12(0 TO 59);  -- ufix12 [60]
  SIGNAL Hough_Kernel_out1_signed         : vector_of_signed12(0 TO 59);  -- sfix12 [60]
  SIGNAL Constant_out1                    : unsigned(10 DOWNTO 0);  -- ufix11
  SIGNAL Add1_v                           : signed(12 DOWNTO 0);  -- sfix13
  SIGNAL Add1_add_temp                    : vector_of_signed13(0 TO 59);  -- sfix13 [60]
  SIGNAL Add1_out1                        : vector_of_unsigned12(0 TO 59);  -- ufix12 [60]
...
BEGIN
  u_Look_Ahead_Hough : Look_Ahead_Hough
    PORT MAP( clk => clk,
              ...
              ysin => Look_Ahead_Hough_out1  -- sfix11 [180]
              );
  ...
  u_Hough_Kernel : Hough_Kernel
    PORT MAP( clk => clk,
              ...
              enb => enb,
              X => X,  -- sfix11
              Y => Look_Ahead_Hough_out1,  -- sfix11 [180]
              Index => Index,  -- uint8 [60]
              Rho => Hough_Kernel_out1  -- sfix12 [60]
              );
  ...
  Constant_out1 <= to_unsigned(16#44E#, 11);

  Add1_v <= signed(resize(Constant_out1, 13));

  Add1_out1_gen: FOR t_0 IN 0 TO 59 GENERATE
    Add1_add_temp(t_0) <= resize(Hough_Kernel_out1_signed(t_0), 13) + Add1_v;
