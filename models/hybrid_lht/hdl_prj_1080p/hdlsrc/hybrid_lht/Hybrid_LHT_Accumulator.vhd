-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_1080p\hdlsrc\hybrid_lht\Hybrid_LHT_Accumulator.vhd
...
ARCHITECTURE rtl OF Hybrid_LHT_Accumulator IS
  ...
  SIGNAL Accumulator_with_Switches_out1   : std_logic_vector(11 DOWNTO 0);  -- ufix12
  SIGNAL Accumulator_with_Switches_out1_unsigned : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL Constant_out1                    : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL Multiport_Switch2_out1           : unsigned(11 DOWNTO 0);  -- ufix12
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              ...
              hough_address => hough_param,  -- ufix12 [60]
              edge_rsvd => AND1_out1,
              mode => mode,
              read_address => read_rsvd,  -- uint16
              clear => clear,
              theta_index => index,  -- uint16
              hps => Accumulator_with_Switches_out1  -- ufix12
              );
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF s_axis_tlast = '1' THEN 
          IF HDL_Counter_out1 >= to_unsigned(16#438#, 11) THEN 
            HDL_Counter_out1 <= to_unsigned(16#000#, 11);
          ELSE 
  ...
  Compare_To_Constant3_out1 <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#438#, 11) ELSE
      '0';

  Constant1_out1 <= to_unsigned(16#003B#, 16);

  Constant2_out1 <= to_unsigned(16#089B#, 16);
  ...
  Compare_To_Constant2_out1 <= '1' WHEN read_unsigned = to_unsigned(16#089B#, 16) ELSE
      '0';
