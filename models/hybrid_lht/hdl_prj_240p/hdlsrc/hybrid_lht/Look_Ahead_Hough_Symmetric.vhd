-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_240p\hdlsrc\hybrid_lht\Look_Ahead_Hough_Symmetric.vhd
...
ENTITY Look_Ahead_Hough_Symmetric IS
  PORT( clk                               :   IN    std_logic;
        ...
        eol                               :   IN    std_logic;
        ysin                              :   OUT   vector_of_std_logic_vector8(0 TO 179)  -- int8 [180]
        );
...
ARCHITECTURE rtl OF Look_Ahead_Hough_Symmetric IS
  ...
  SIGNAL Matrix_Concatenate_out1          : vector_of_signed8(0 TO 179);  -- int8 [180]
