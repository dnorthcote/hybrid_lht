-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_240p\hdlsrc\hybrid_lht\Hybrid_LHT_Accumulator.vhd
...
BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF s_axis_tlast = '1' THEN 
          IF HDL_Counter_out1 >= to_unsigned(16#F0#, 8) THEN 
            HDL_Counter_out1 <= to_unsigned(16#00#, 8);
          ELSE 
  ...
  Compare_To_Constant3_out1 <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#F0#, 8) ELSE
      '0';

  Constant1_out1 <= to_unsigned(16#002C#, 16);

  Constant2_out1 <= to_unsigned(16#018F#, 16);
  ...
  Compare_To_Constant2_out1 <= '1' WHEN read_unsigned = to_unsigned(16#018F#, 16) ELSE
      '0';
