-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_333_Zhou\hdlsrc\hybrid_lht\Hybrid_LHT.vhd
...
ARCHITECTURE rtl OF Hybrid_LHT IS
  ...
  SIGNAL Hybrid_LHT_Kernel_out4           : vector_of_std_logic_vector9(0 TO 44);  -- ufix9 [45]
  SIGNAL y                                : std_logic;  -- ufix1
  SIGNAL Hybrid_LHT_Kernel_out6           : vector_of_std_logic_vector6(0 TO 44);  -- ufix6 [45]
  SIGNAL Hybrid_LHT_Accumulator_out1      : std_logic;
  SIGNAL Hybrid_LHT_Accumulator_out2      : std_logic_vector(8 DOWNTO 0);  -- ufix9
...
BEGIN
  u_Hybrid_LHT_Kernel : Hybrid_LHT_Kernel
    PORT MAP( clk => clk,
              ...
              hough_param => Hybrid_LHT_Kernel_out4,  -- ufix9 [45]
              edge_rsvd => y,  -- ufix1
              shift => Hybrid_LHT_Kernel_out6  -- ufix6 [45]
              );
  ...
  u_Hybrid_LHT_Accumulator : Hybrid_LHT_Accumulator
    PORT MAP( clk => clk,
              ...
              m_axis_tdata => Hybrid_LHT_Accumulator_out2,  -- ufix9
