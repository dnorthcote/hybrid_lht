-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_333_Zhou\hdlsrc\hybrid_lht\Accumulator_with_Switches.vhd
...
ARCHITECTURE rtl OF Accumulator_with_Switches IS
  ...
  SIGNAL Data_Type_Conversion_out1_1      : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL Data_Type_Conversion_out1_scalarexpand : vector_of_unsigned9(0 TO 44);  -- ufix9 [45]
  SIGNAL hough_address_unsigned           : vector_of_unsigned9(0 TO 44);  -- ufix9 [45]
  SIGNAL Switch_out1                      : vector_of_unsigned9(0 TO 44);  -- ufix9 [45]
  SIGNAL Switch_out1_1                    : vector_of_std_logic_vector9(0 TO 44);  -- ufix9 [45]
  ...
  SIGNAL delayMatch92_reg                 : vector_of_unsigned16(0 TO 1);  -- ufix16 [2]
  SIGNAL Delay_out1_1                     : unsigned(15 DOWNTO 0);  -- uint16
  SIGNAL Accumulator_out1                 : vector_of_std_logic_vector9(0 TO 44);  -- ufix9 [45]
  SIGNAL Accumulator_out1_unsigned        : vector_of_unsigned9(0 TO 44);  -- ufix9 [45]
  SIGNAL Selector_out1                    : unsigned(8 DOWNTO 0);  -- ufix9
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= read_address_unsigned(8 DOWNTO 0);

  delayMatch1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      delayMatch1_reg <= (OTHERS => to_unsigned(16#000#, 9));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      delayMatch92_reg <= (OTHERS => to_unsigned(16#0000#, 16));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Delay_out1_1 <= delayMatch92_reg(1);
  ...
  GEN_LABEL: FOR k IN 0 TO 44 GENERATE
    u_Accumulator : Accumulator
      PORT MAP( clk => clk,
                ...
                shift => shift(k),  -- ufix6
                mode => mode_1,
                address => Switch_out1_1(k),  -- ufix9
                edge_rsvd => Multiport_Switch1_out1_1,
                hps => Accumulator_out1(k)  -- ufix9
                );
  END GENERATE;
