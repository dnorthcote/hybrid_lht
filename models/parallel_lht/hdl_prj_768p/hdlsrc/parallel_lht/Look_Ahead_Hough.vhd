-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_768p\hdlsrc\parallel_lht\Look_Ahead_Hough.vhd
...
ARCHITECTURE rtl OF Look_Ahead_Hough IS
  ...
  SIGNAL Matrix_Concatenate_out1          : vector_of_signed10(0 TO 90);  -- sfix10 [91]
...
BEGIN
  ...
  row_0_out1(1) <= to_signed(-16#007#, 10);
  row_0_out1(2) <= to_signed(-16#00D#, 10);
  row_0_out1(3) <= to_signed(-16#014#, 10);
  row_0_out1(4) <= to_signed(-16#01B#, 10);
  row_0_out1(5) <= to_signed(-16#021#, 10);
  row_0_out1(6) <= to_signed(-16#028#, 10);
  row_0_out1(7) <= to_signed(-16#02F#, 10);
  row_0_out1(8) <= to_signed(-16#035#, 10);
  row_0_out1(9) <= to_signed(-16#03C#, 10);
  row_0_out1(10) <= to_signed(-16#043#, 10);
  row_0_out1(11) <= to_signed(-16#049#, 10);
  row_0_out1(12) <= to_signed(-16#050#, 10);
  row_0_out1(13) <= to_signed(-16#056#, 10);
  row_0_out1(14) <= to_signed(-16#05D#, 10);
  row_0_out1(15) <= to_signed(-16#063#, 10);
  row_0_out1(16) <= to_signed(-16#06A#, 10);
  row_0_out1(17) <= to_signed(-16#070#, 10);
  row_0_out1(18) <= to_signed(-16#077#, 10);
  row_0_out1(19) <= to_signed(-16#07D#, 10);
  row_0_out1(20) <= to_signed(-16#083#, 10);
  row_0_out1(21) <= to_signed(-16#08A#, 10);
  row_0_out1(22) <= to_signed(-16#090#, 10);
  row_0_out1(23) <= to_signed(-16#096#, 10);
  row_0_out1(24) <= to_signed(-16#09C#, 10);
  row_0_out1(25) <= to_signed(-16#0A2#, 10);
  row_0_out1(26) <= to_signed(-16#0A8#, 10);
  row_0_out1(27) <= to_signed(-16#0AE#, 10);
  row_0_out1(28) <= to_signed(-16#0B4#, 10);
  row_0_out1(29) <= to_signed(-16#0BA#, 10);
  row_0_out1(30) <= to_signed(-16#0C0#, 10);
  row_0_out1(31) <= to_signed(-16#0C6#, 10);
  row_0_out1(32) <= to_signed(-16#0CB#, 10);
  row_0_out1(33) <= to_signed(-16#0D1#, 10);
  row_0_out1(34) <= to_signed(-16#0D7#, 10);
  row_0_out1(35) <= to_signed(-16#0DC#, 10);
  row_0_out1(36) <= to_signed(-16#0E2#, 10);
  row_0_out1(37) <= to_signed(-16#0E7#, 10);
  row_0_out1(38) <= to_signed(-16#0EC#, 10);
  row_0_out1(39) <= to_signed(-16#0F2#, 10);
  row_0_out1(40) <= to_signed(-16#0F7#, 10);
  row_0_out1(41) <= to_signed(-16#0FC#, 10);
  row_0_out1(42) <= to_signed(-16#101#, 10);
  row_0_out1(43) <= to_signed(-16#106#, 10);
  row_0_out1(44) <= to_signed(-16#10B#, 10);
  row_0_out1(45) <= to_signed(-16#110#, 10);
  row_0_out1(46) <= to_signed(-16#114#, 10);
  row_0_out1(47) <= to_signed(-16#119#, 10);
  row_0_out1(48) <= to_signed(-16#11D#, 10);
  row_0_out1(49) <= to_signed(-16#122#, 10);
  row_0_out1(50) <= to_signed(-16#126#, 10);
  row_0_out1(51) <= to_signed(-16#12A#, 10);
  row_0_out1(52) <= to_signed(-16#12F#, 10);
  row_0_out1(53) <= to_signed(-16#133#, 10);
  row_0_out1(54) <= to_signed(-16#137#, 10);
  row_0_out1(55) <= to_signed(-16#13B#, 10);
  row_0_out1(56) <= to_signed(-16#13E#, 10);
  row_0_out1(57) <= to_signed(-16#142#, 10);
  row_0_out1(58) <= to_signed(-16#146#, 10);
  row_0_out1(59) <= to_signed(-16#149#, 10);
  row_0_out1(60) <= to_signed(-16#14D#, 10);
  row_0_out1(61) <= to_signed(-16#150#, 10);
  row_0_out1(62) <= to_signed(-16#153#, 10);
  row_0_out1(63) <= to_signed(-16#156#, 10);
  row_0_out1(64) <= to_signed(-16#159#, 10);
  row_0_out1(65) <= to_signed(-16#15C#, 10);
  row_0_out1(66) <= to_signed(-16#15F#, 10);
  row_0_out1(67) <= to_signed(-16#161#, 10);
  row_0_out1(68) <= to_signed(-16#164#, 10);
  row_0_out1(69) <= to_signed(-16#167#, 10);
  row_0_out1(70) <= to_signed(-16#169#, 10);
  row_0_out1(71) <= to_signed(-16#16B#, 10);
  row_0_out1(72) <= to_signed(-16#16D#, 10);
  row_0_out1(73) <= to_signed(-16#16F#, 10);
  row_0_out1(74) <= to_signed(-16#171#, 10);
  row_0_out1(75) <= to_signed(-16#173#, 10);
  row_0_out1(76) <= to_signed(-16#175#, 10);
  row_0_out1(77) <= to_signed(-16#176#, 10);
  row_0_out1(78) <= to_signed(-16#178#, 10);
  row_0_out1(79) <= to_signed(-16#179#, 10);
  row_0_out1(80) <= to_signed(-16#17A#, 10);
  row_0_out1(81) <= to_signed(-16#17B#, 10);
  row_0_out1(82) <= to_signed(-16#17C#, 10);
  row_0_out1(83) <= to_signed(-16#17D#, 10);
  row_0_out1(84) <= to_signed(-16#17E#, 10);
  row_0_out1(85) <= to_signed(-16#17F#, 10);
  row_0_out1(86) <= to_signed(-16#17F#, 10);
  row_0_out1(87) <= to_signed(-16#17F#, 10);
  row_0_out1(88) <= to_signed(-16#180#, 10);
  row_0_out1(89) <= to_signed(-16#180#, 10);
  row_0_out1(90) <= to_signed(-16#180#, 10);
