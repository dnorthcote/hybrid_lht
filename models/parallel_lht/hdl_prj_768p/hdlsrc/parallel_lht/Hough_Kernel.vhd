-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_768p\hdlsrc\parallel_lht\Hough_Kernel.vhd
...
ARCHITECTURE rtl OF Hough_Kernel IS
  ...
  -- Signals
  SIGNAL Hough_Kernel_Symmetric_Look_Ahead_out1 : vector_of_std_logic_vector11(0 TO 179);  -- ufix11 [180]
...
BEGIN
  u_Hough_Kernel_Symmetric_Look_Ahead : Hough_Kernel_Symmetric_Look_Ahead
    PORT MAP( clk => clk,
              ...
              X => X,  -- sfix10
              Y => Y,  -- sfix10
              Rho => Hough_Kernel_Symmetric_Look_Ahead_out1  -- sfix11 [180]
              );
