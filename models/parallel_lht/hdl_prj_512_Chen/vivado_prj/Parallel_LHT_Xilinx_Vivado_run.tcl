...
set myProject "Parallel_LHT_vivado"
set myProjectFile "Parallel_LHT_vivado.xpr"
set myTopLevelEntity "Parallel_LHT"
...
puts "### Open existing $myTool project hdl_prj_512_Chen\\vivado_prj\\Parallel_LHT_vivado.xpr"
