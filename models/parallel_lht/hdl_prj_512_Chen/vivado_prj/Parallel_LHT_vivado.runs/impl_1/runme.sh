...
HD_PWD='C:/hybrid_lht/models/parallel_lht/hdl_prj_512_Chen/vivado_prj/Parallel_LHT_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallel_LHT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parallel_LHT.tcl -notrace
