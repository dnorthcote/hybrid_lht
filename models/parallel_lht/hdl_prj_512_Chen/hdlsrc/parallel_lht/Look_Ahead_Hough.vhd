-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_512_Chen\hdlsrc\parallel_lht\Look_Ahead_Hough.vhd
...
BEGIN
  ...
  Compare_To_Constant_out1 <= '1' WHEN Y_signed = to_signed(-16#100#, 9) ELSE
      '0';
  ...
  row_0_out1(2) <= to_signed(-16#009#, 9);
  row_0_out1(3) <= to_signed(-16#00D#, 9);
  row_0_out1(4) <= to_signed(-16#012#, 9);
  row_0_out1(5) <= to_signed(-16#016#, 9);
  row_0_out1(6) <= to_signed(-16#01B#, 9);
  row_0_out1(7) <= to_signed(-16#01F#, 9);
  row_0_out1(8) <= to_signed(-16#024#, 9);
  row_0_out1(9) <= to_signed(-16#028#, 9);
  row_0_out1(10) <= to_signed(-16#02C#, 9);
  row_0_out1(11) <= to_signed(-16#031#, 9);
  row_0_out1(12) <= to_signed(-16#035#, 9);
  row_0_out1(13) <= to_signed(-16#03A#, 9);
  row_0_out1(14) <= to_signed(-16#03E#, 9);
  row_0_out1(15) <= to_signed(-16#042#, 9);
  row_0_out1(16) <= to_signed(-16#047#, 9);
  row_0_out1(17) <= to_signed(-16#04B#, 9);
  row_0_out1(18) <= to_signed(-16#04F#, 9);
  row_0_out1(19) <= to_signed(-16#053#, 9);
  row_0_out1(20) <= to_signed(-16#058#, 9);
  row_0_out1(21) <= to_signed(-16#05C#, 9);
  row_0_out1(22) <= to_signed(-16#060#, 9);
  row_0_out1(23) <= to_signed(-16#064#, 9);
  row_0_out1(24) <= to_signed(-16#068#, 9);
  row_0_out1(25) <= to_signed(-16#06C#, 9);
  row_0_out1(26) <= to_signed(-16#070#, 9);
  row_0_out1(27) <= to_signed(-16#074#, 9);
  row_0_out1(28) <= to_signed(-16#078#, 9);
  row_0_out1(29) <= to_signed(-16#07C#, 9);
  row_0_out1(30) <= to_signed(-16#080#, 9);
  row_0_out1(31) <= to_signed(-16#084#, 9);
  row_0_out1(32) <= to_signed(-16#088#, 9);
  row_0_out1(33) <= to_signed(-16#08B#, 9);
  row_0_out1(34) <= to_signed(-16#08F#, 9);
  row_0_out1(35) <= to_signed(-16#093#, 9);
  row_0_out1(36) <= to_signed(-16#096#, 9);
  row_0_out1(37) <= to_signed(-16#09A#, 9);
  row_0_out1(38) <= to_signed(-16#09E#, 9);
  row_0_out1(39) <= to_signed(-16#0A1#, 9);
  row_0_out1(40) <= to_signed(-16#0A5#, 9);
  row_0_out1(41) <= to_signed(-16#0A8#, 9);
  row_0_out1(42) <= to_signed(-16#0AB#, 9);
  row_0_out1(43) <= to_signed(-16#0AF#, 9);
  row_0_out1(44) <= to_signed(-16#0B2#, 9);
  row_0_out1(45) <= to_signed(-16#0B5#, 9);
  row_0_out1(46) <= to_signed(-16#0B8#, 9);
  row_0_out1(47) <= to_signed(-16#0BB#, 9);
  row_0_out1(48) <= to_signed(-16#0BE#, 9);
  row_0_out1(49) <= to_signed(-16#0C1#, 9);
  row_0_out1(50) <= to_signed(-16#0C4#, 9);
  row_0_out1(51) <= to_signed(-16#0C7#, 9);
  row_0_out1(52) <= to_signed(-16#0CA#, 9);
  row_0_out1(53) <= to_signed(-16#0CC#, 9);
  row_0_out1(54) <= to_signed(-16#0CF#, 9);
  row_0_out1(55) <= to_signed(-16#0D2#, 9);
  row_0_out1(56) <= to_signed(-16#0D4#, 9);
  row_0_out1(57) <= to_signed(-16#0D7#, 9);
  row_0_out1(58) <= to_signed(-16#0D9#, 9);
  row_0_out1(59) <= to_signed(-16#0DB#, 9);
  row_0_out1(60) <= to_signed(-16#0DE#, 9);
  row_0_out1(61) <= to_signed(-16#0E0#, 9);
  row_0_out1(62) <= to_signed(-16#0E2#, 9);
  row_0_out1(63) <= to_signed(-16#0E4#, 9);
  row_0_out1(64) <= to_signed(-16#0E6#, 9);
  row_0_out1(65) <= to_signed(-16#0E8#, 9);
  row_0_out1(66) <= to_signed(-16#0EA#, 9);
  row_0_out1(67) <= to_signed(-16#0EC#, 9);
  row_0_out1(68) <= to_signed(-16#0ED#, 9);
  row_0_out1(69) <= to_signed(-16#0EF#, 9);
  row_0_out1(70) <= to_signed(-16#0F1#, 9);
  row_0_out1(71) <= to_signed(-16#0F2#, 9);
  row_0_out1(72) <= to_signed(-16#0F3#, 9);
  row_0_out1(73) <= to_signed(-16#0F5#, 9);
  row_0_out1(74) <= to_signed(-16#0F6#, 9);
  row_0_out1(75) <= to_signed(-16#0F7#, 9);
  row_0_out1(76) <= to_signed(-16#0F8#, 9);
  row_0_out1(77) <= to_signed(-16#0F9#, 9);
  row_0_out1(78) <= to_signed(-16#0FA#, 9);
  row_0_out1(79) <= to_signed(-16#0FB#, 9);
  row_0_out1(80) <= to_signed(-16#0FC#, 9);
  row_0_out1(81) <= to_signed(-16#0FD#, 9);
  row_0_out1(82) <= to_signed(-16#0FE#, 9);
  row_0_out1(83) <= to_signed(-16#0FE#, 9);
  row_0_out1(84) <= to_signed(-16#0FF#, 9);
  row_0_out1(85) <= to_signed(-16#0FF#, 9);
  row_0_out1(86) <= to_signed(-16#0FF#, 9);
  row_0_out1(87) <= to_signed(-16#100#, 9);
  row_0_out1(88) <= to_signed(-16#100#, 9);
  row_0_out1(89) <= to_signed(-16#100#, 9);
  row_0_out1(90) <= to_signed(-16#100#, 9);
