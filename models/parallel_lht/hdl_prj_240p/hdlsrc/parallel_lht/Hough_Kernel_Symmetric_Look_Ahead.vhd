-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_240p\hdlsrc\parallel_lht\Hough_Kernel_Symmetric_Look_Ahead.vhd
...
ARCHITECTURE rtl OF Hough_Kernel_Symmetric_Look_Ahead IS
  ...
  SIGNAL Look_Ahead_Hough_out1            : vector_of_std_logic_vector8(0 TO 90);  -- ufix8 [91]
...
BEGIN
  u_Look_Ahead_Hough : Look_Ahead_Hough
    PORT MAP( clk => clk,
              ...
              ysin => Look_Ahead_Hough_out1  -- int8 [91]
              );
