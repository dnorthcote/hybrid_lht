-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_480p\hdlsrc\parallel_lht\Accumulator.vhd
...
ARCHITECTURE rtl OF Accumulator IS
  ...
  SIGNAL Block_RAM_out1                   : std_logic_vector(9 DOWNTO 0);  -- ufix10
  SIGNAL Block_RAM_out1_unsigned          : unsigned(9 DOWNTO 0);  -- ufix10
...
BEGIN
  u_Block_RAM : Block_RAM
    PORT MAP( clk => clk,
              enb => enb,
              wr_data => std_logic_vector(Multiport_Switch_out1),  -- ufix10
              wr_addr => std_logic_vector(Delay_out1),  -- ufix10
              wr_en => Delay1_out1,
              rd_addr => address,  -- ufix10
              rd_data => Block_RAM_out1  -- ufix10
              );
