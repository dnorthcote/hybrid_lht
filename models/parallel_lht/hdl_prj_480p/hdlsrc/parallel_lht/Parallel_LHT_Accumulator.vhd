-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_480p\hdlsrc\parallel_lht\Parallel_LHT_Accumulator.vhd
...
ARCHITECTURE rtl OF Parallel_LHT_Accumulator IS
  ...
  COMPONENT Accumulator_with_Switches
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hough_address                   :   IN    vector_of_std_logic_vector10(0 TO 179);  -- ufix10 [180]
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hough_address => hough_param,  -- ufix10 [180]
              edge_rsvd => AND1_out1,
              mode => mode,
