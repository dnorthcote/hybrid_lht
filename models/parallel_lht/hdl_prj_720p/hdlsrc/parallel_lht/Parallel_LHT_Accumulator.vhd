-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_720p\hdlsrc\parallel_lht\Parallel_LHT_Accumulator.vhd
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hough_address => hough_param,  -- ufix11 [180]
              edge_rsvd => AND1_out1,
              mode => mode,
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        ELSIF s_axis_tlast = '1' THEN 
          IF HDL_Counter_out1 >= to_unsigned(16#2D0#, 10) THEN 
            HDL_Counter_out1 <= to_unsigned(16#000#, 10);
          ELSE 
  ...
  Compare_To_Constant3_out1 <= '1' WHEN HDL_Counter_out1 = to_unsigned(16#2D0#, 10) ELSE
      '0';

  Constant1_out1 <= to_unsigned(16#00B3#, 16);

  Constant2_out1 <= to_unsigned(16#05BD#, 16);
  ...
  Compare_To_Constant2_out1 <= '1' WHEN read_unsigned = to_unsigned(16#05BD#, 16) ELSE
      '0';
