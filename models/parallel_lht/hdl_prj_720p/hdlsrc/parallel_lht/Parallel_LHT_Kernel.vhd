-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_720p\hdlsrc\parallel_lht\Parallel_LHT_Kernel.vhd
...
ARCHITECTURE rtl OF Parallel_LHT_Kernel IS
  ...
  SIGNAL Hough_Kernel_out1                : vector_of_std_logic_vector11(0 TO 179);  -- ufix11 [180]
  SIGNAL Hough_Kernel_out1_signed         : vector_of_signed11(0 TO 179);  -- sfix11 [180]
  SIGNAL Add1_u                           : signed(11 DOWNTO 0);  -- sfix12
  SIGNAL Add1_add_temp                    : vector_of_signed12(0 TO 179);  -- sfix12 [180]
  SIGNAL Add1_out1                        : vector_of_unsigned11(0 TO 179);  -- ufix11 [180]
...
BEGIN
  u_Hough_Kernel : Hough_Kernel
    PORT MAP( clk => clk,
              ...
              Rho => Hough_Kernel_out1  -- sfix11 [180]
              );
  ...
  Constant1_out1 <= to_unsigned(16#2DF#, 10);

  outputgen1: FOR k IN 0 TO 179 GENERATE
    Hough_Kernel_out1_signed(k) <= signed(Hough_Kernel_out1(k));
  END GENERATE;

  Add1_u <= signed(resize(Constant1_out1, 12));

  Add1_out1_gen: FOR t_0 IN 0 TO 179 GENERATE
    Add1_add_temp(t_0) <= Add1_u + resize(Hough_Kernel_out1_signed(t_0), 12);
