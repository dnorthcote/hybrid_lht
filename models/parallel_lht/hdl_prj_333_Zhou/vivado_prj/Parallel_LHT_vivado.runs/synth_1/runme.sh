...
HD_PWD='C:/hybrid_lht/models/parallel_lht/hdl_prj_333_Zhou/vivado_prj/Parallel_LHT_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallel_LHT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Parallel_LHT.tcl
