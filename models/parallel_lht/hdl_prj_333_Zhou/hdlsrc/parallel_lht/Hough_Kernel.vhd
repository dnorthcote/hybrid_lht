-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_333_Zhou\hdlsrc\parallel_lht\Hough_Kernel.vhd
...
ARCHITECTURE rtl OF Hough_Kernel IS
  ...
  -- Signals
  SIGNAL Hough_Kernel_Symmetric_Look_Ahead_out1 : vector_of_std_logic_vector9(0 TO 179);  -- ufix9 [180]
...
BEGIN
  u_Hough_Kernel_Symmetric_Look_Ahead : Hough_Kernel_Symmetric_Look_Ahead
    PORT MAP( clk => clk,
              ...
              X => X,  -- sfix9
              Y => Y,  -- sfix9
              Rho => Hough_Kernel_Symmetric_Look_Ahead_out1  -- sfix9 [180]
              );
