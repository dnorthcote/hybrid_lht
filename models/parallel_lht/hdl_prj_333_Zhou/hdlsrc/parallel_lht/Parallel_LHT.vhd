-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_333_Zhou\hdlsrc\parallel_lht\Parallel_LHT.vhd
...
ARCHITECTURE rtl OF Parallel_LHT IS
  ...
  SIGNAL Parallel_LHT_Kernel_out5         : vector_of_std_logic_vector9(0 TO 179);  -- ufix9 [180]
  SIGNAL Parallel_LHT_Accumulator_out1    : std_logic;
  SIGNAL Parallel_LHT_Accumulator_out2    : std_logic_vector(8 DOWNTO 0);  -- ufix9
...
BEGIN
  u_Parallel_LHT_Kernel : Parallel_LHT_Kernel
    PORT MAP( clk => clk,
              ...
              hough_param => Parallel_LHT_Kernel_out5  -- ufix9 [180]
              );
  ...
  u_Parallel_LHT_Accumulator : Parallel_LHT_Accumulator
    PORT MAP( clk => clk,
              ...
              m_axis_tdata => Parallel_LHT_Accumulator_out2,  -- ufix9
