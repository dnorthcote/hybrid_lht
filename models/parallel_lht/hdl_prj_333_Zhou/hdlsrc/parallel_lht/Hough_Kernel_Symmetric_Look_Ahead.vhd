-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_333_Zhou\hdlsrc\parallel_lht\Hough_Kernel_Symmetric_Look_Ahead.vhd
...
ARCHITECTURE rtl OF Hough_Kernel_Symmetric_Look_Ahead IS
  ...
  SIGNAL Hough_Kernel_Symmetric_out1      : vector_of_std_logic_vector9(0 TO 179);  -- ufix9 [180]
...
BEGIN
  ...
  u_Hough_Kernel_Symmetric : Hough_Kernel_Symmetric
    PORT MAP( clk => clk,
              ...
              X => X,  -- sfix9
              ysin => Look_Ahead_Hough_out1,  -- sfix9 [91]
              Rho => Hough_Kernel_Symmetric_out1  -- sfix9 [180]
              );
