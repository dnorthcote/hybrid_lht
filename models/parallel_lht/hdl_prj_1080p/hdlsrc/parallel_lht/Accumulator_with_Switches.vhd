-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_1080p\hdlsrc\parallel_lht\Accumulator_with_Switches.vhd
...
ENTITY Accumulator_with_Switches IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        hough_address                     :   IN    vector_of_std_logic_vector12(0 TO 179);  -- ufix12 [180]
...
ARCHITECTURE rtl OF Accumulator_with_Switches IS
  ...
  SIGNAL Data_Type_Conversion_out1_scalarexpand : vector_of_unsigned12(0 TO 179);  -- ufix12 [180]
  SIGNAL hough_address_unsigned           : vector_of_unsigned12(0 TO 179);  -- ufix12 [180]
  SIGNAL Switch_out1                      : vector_of_unsigned12(0 TO 179);  -- ufix12 [180]
  SIGNAL Switch_out1_1                    : vector_of_std_logic_vector12(0 TO 179);  -- ufix12 [180]
  ...
  SIGNAL Accumulator_out1                 : vector_of_std_logic_vector12(0 TO 179);  -- ufix12 [180]
  SIGNAL Accumulator_out1_unsigned        : vector_of_unsigned12(0 TO 179);  -- ufix12 [180]
