-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj_1080p\hdlsrc\parallel_lht\Parallel_LHT_Accumulator.vhd
...
ENTITY Parallel_LHT_Accumulator IS
  PORT( clk                               :   IN    std_logic;
        ...
        hough_param                       :   IN    vector_of_std_logic_vector12(0 TO 179);  -- ufix12 [180]
...
BEGIN
  ...
  u_Accumulator_with_Switches : Accumulator_with_Switches
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hough_address => hough_param,  -- ufix12 [180]
              edge_rsvd => AND1_out1,
              mode => mode,
