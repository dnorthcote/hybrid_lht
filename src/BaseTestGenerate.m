name = {'1080p', '1024p', '720p', '768o', '768p', '600o', '480p', '512o', '333o' '240p'};
width = [1920, 1280, 1280, 1024, 1024, 800, 640, 512, 333, 320];
height = [1080, 1024, 720, 768, 768, 600, 480, 512, 333, 240];
